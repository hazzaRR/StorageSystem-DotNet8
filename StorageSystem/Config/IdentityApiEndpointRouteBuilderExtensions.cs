...
namespace StorageSystem.Config
{
    ...
    public static class IdentityApiEndpointRouteBuilderExtensions
    {
        ...
        public static IEndpointConventionBuilder MapCustomisedIdentityApi<TUser>(this IEndpointRouteBuilder endpoints)
            where TUser : class, new()
        {
                ...
                ([FromBody] RegisterRequest registration, HttpContext context, [FromServices] IServiceProvider sp) =>
            {
                ...
                {
                    throw new NotSupportedException($"{nameof(MapCustomisedIdentityApi)} requires a user store with email support.");
                }
            ...
            .Add(endpointBuilder =>
            {
                ...
                confirmEmailEndpointName = $"{nameof(MapCustomisedIdentityApi)}-{finalPattern}";
